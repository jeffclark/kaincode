...
+ (id)metalTableColumnHeaderGradient
{
	id newInstance = [[[self class] alloc] init];
	
	CTGradientElement color1;
	color1.red   = 122/255.0;
	color1.green = 122/255.0;
	color1.blue  = 122/255.0;
	color1.alpha = 1.00;
	color1.position = 0;
	
	CTGradientElement color2;
	color2.red   = 238/255.0;
	color2.green = 238/255.0;
	color2.blue  = 238/255.0;
	color2.alpha = 238/255.0;
	color2.position = 1;
...
+ (id)itunes7SelectedGradient
{
	id newInstance = [[[self class] alloc] init];
	
	CTGradientElement color1;
	color1.red   = 17/255.0;
	color1.green = 34/255.0;
	color1.blue  = 45/255.0;
	color1.alpha = 1.00;
	color1.position = 1.0;
	
	CTGradientElement color2;
	color2.red   = 17/255.0;
	color2.green = 34/255.0;
	color2.blue  = 45/255.0;
	color2.alpha = 1.00;
	color2.position = 0.5;

	CTGradientElement color3;
	color3.red   = 17/255.0;
	color3.green = 20/255.0;
	color3.blue  = 23/255.0;
	color3.alpha = 1.0;
	color3.position = 0.5;
	
	CTGradientElement color4;
	color4.red   = 17/255.0;
	color4.green = 45/255.0;
	color4.blue  = 61/255.0;
	color4.alpha = 1.0;
	color4.position = 0.0;
...
+ (id)itunes7UnselectedGradient
{
	id newInstance = [[[self class] alloc] init];
	
	CTGradientElement color1;
	color1.red   = 103/255.0;
	color1.green = 104/255.0;
	color1.blue  = 105/255.0;
	color1.alpha = 1.00;
	color1.position = 1.0;
	
	CTGradientElement color2;
	color2.red   = 103/255.0;
	color2.green = 104/255.0;
	color2.blue  = 105/255.0;
	color2.alpha = 1.00;
	color2.position = 0.5;
	
	CTGradientElement color3;
	color3.red   = 90/255.0;
	color3.green = 91/255.0;
	color3.blue  = 92/255.0;
	color3.alpha = 1.0;
	color3.position = 0.5;
	
	CTGradientElement color4;
	color4.red   = 121/255.0;
	color4.green = 122/255.0;
	color4.blue  = 123/255.0;
	color4.alpha = 1.0;
	color4.position = 0.0;
...
+ (id)mailButtonBarGradient
{
	id newInstance = [[[self class] alloc] init];
	
	CTGradientElement color1;
	color1.red   = 253/255.0;
	color1.green = 253/255.0;
	color1.blue  = 253/255.0;
	color1.alpha = 1.00;
	color1.position = 1.0;
	
	CTGradientElement color2;
	color2.red   = 243/255.0;
	color2.green = 243/255.0;
	color2.blue  = 243/255.0;
	color2.alpha = 1.00;
	color2.position = 0.5;
	
	CTGradientElement color3;
	color3.red   = 230/255.0;
	color3.green = 230/255.0;
	color3.blue  = 230/255.0;
	color3.alpha = 1.0;
	color3.position = 0.5;
	
	CTGradientElement color4;
	color4.red   = 230/255.0;
	color4.green = 230/255.0;
	color4.blue  = 230/255.0;
	color4.alpha = 1.0;
	color4.position = 0.0;
...
+ (id)mailSelectedButtonBarGradient
{
	id newInstance = [[[self class] alloc] init];
	
	CTGradientElement color1;
	color1.red   = 165/255.0;
	color1.green = 165/255.0;
	color1.blue  = 165/255.0;
	color1.alpha = 1.00;
	color1.position = 1.0;
	
	CTGradientElement color2;
	color2.red   = 158/255.0;
	color2.green = 158/255.0;
	color2.blue  = 158/255.0;
	color2.alpha = 1.00;
	color2.position = 0.5;
	
	CTGradientElement color3;
	color3.red   = 150/255.0;
	color3.green = 150/255.0;
	color3.blue  = 150/255.0;
	color3.alpha = 1.0;
	color3.position = 0.5;
	
	CTGradientElement color4;
	color4.red   = 150/255.0;
	color4.green = 150/255.0;
	color4.blue  = 150/255.0;
	color4.alpha = 1.0;
	color4.position = 0.0;
...
+ (id)mailSplitViewGradient
{
	return [[self class] gradientWithBeginningColor:[NSColor colorWithCalibratedWhite:223/255.0 alpha:1.0]
										endingColor:[NSColor colorWithCalibratedWhite:253/255.0 alpha:1.0]];
}
